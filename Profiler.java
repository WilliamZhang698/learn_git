...
public final class Profiler {
    ...
    public static boolean hasHttp() {
        Object object = entryStack.get();
        return object != null && StringUtil.indexOf(object.toString(), "Start HTTP!") > 0;
    }
    ...
    public static enum MessageLevel {
        NO_MESSAGE(0, "NO_MESSAGE"),
        BRIEF_MESSAGE(1, "BRIEF_MESSAGE"),
        DETAILED_MESSAGE(2, "DETAILED_MESSAGE");

        private Integer value = null;
        private String message = null;

        private MessageLevel(Integer value, String message) {
            this.value = value;
